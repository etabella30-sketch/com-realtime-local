            ...
            for (const file of files.reverse()) {
                ...
                try {
                    ...
                    if (recData) {
                        ...
                        this.io["server"].to(userId).emit('previous-data', { msg: 1, page: pgNo, data: recData, totalPages: files.length, nSesid: data.nSesid, a: aDATA, h: hDATA, tab: data.tab, tabSessionId: data?.tabSessionId });
                    }
                } catch (error) {

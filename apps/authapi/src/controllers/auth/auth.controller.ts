...
import { SignInReq, SignInResponce, SignInRTReq, SignOutReq, SignOutResponce, UserInfoReq } from '../../interfaces/auth.interface';
...
export class AuthController {
    ...
    @Post('signinrt')
    async signInRT(@Body() body: SignInRTReq): Promise<SignInResponce> {
        return await this.authService.signInRT(body);
    }

...
export class AnnotTransferService {
    ...
    async startTransfer(nSesid: Number, filePath: string, cProtocol: string): Promise<any> {
    ...
    async transferAnnotations(nSesid: Number, filePath: string, cProtocol: string): Promise<boolean> {

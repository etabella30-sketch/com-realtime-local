...
import { roleModuleReq, roleModuleRes, roleModuleUpdateReq, roleModuleUpdateRes, rolePermissionReq, roleStatusReq, roleStatusRes, userModuleReq, userPermissionReq, userQuotaReq, userQuotaRes, userStatusReq, userStatusRes } from 'apps/coreapi/src/interfaces/permissions.interface';

...
export class SessionController {
  ...
  constructor(private sb: SessionbuilderService, private dwn: DownloadfileService, private session: SessionService, private syncService: SyncService, private emailService: EmailService) { }

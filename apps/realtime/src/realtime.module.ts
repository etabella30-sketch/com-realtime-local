...
@Module({
  imports: [GlobalModule,
    ...
    ServeStaticModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        const publicDir = configService.get<string>('PUBLIC_DIR');
        console.log('\n\r\n\r\n\r TRE', publicDir);
        return [
          {
  ...
  controllers: [AuthController, RealtimeController, TcpController, SessionController, IssueController],
  providers: [RealtimeService, TcpService, UtilityService, ParseDataService, SocketService, ConfigService, SessionBackupService, ExportService,
    ...
    TranscriptpublishService, TranscriptHtmlService, ThemeCssService, TranscriptService, TransferHighlightsService, RhighlightsService, FuzzySearchService, AnnotDataService, RapidfuzzService, JsonLogService, TransferHealthService, IdentityFixService],
})
